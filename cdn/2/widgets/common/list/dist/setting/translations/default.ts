export default {
  ...
  remindCustomLayoutText: 'By using custom layout, you can manually arrange widgets for this status.',
  remindCustomLayoutBottomText: 'However, widgets added in the regular status will not be automatically added here. Alternatively, you can manually select the widget on the regular status, click on the link button and apply that widget here.',
  remindAutoLayoutText: 'By using auto layout, widgets wil be synced with those on the regular status and arranged automatically.',
